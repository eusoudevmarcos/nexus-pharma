...
export async function proxyPortal(path: string, init: RequestInit) {
  ...
  if (!upstream.ok) {
    const messages: Record<string, string> = {
      ...
      COMPARTILHAMENTO_NAO_ENCONTRADO: "Este compartilhamento não pertence à sua farmácia.",
      COMPARTILHAMENTO_ENCERRADO: "Compartilhamento encerrado pela Nexus. Fale com seu consultor para reabrir.",
      COMPARTILHAMENTO_SUSPENSO_PELA_NEXUS: "Este compartilhamento foi suspenso pela Nexus; só ela pode religar.",
      ENCERRAMENTO_SO_PELA_NEXUS: "Para encerrar de vez, fale com a Nexus. Você pode suspender a qualquer momento.",

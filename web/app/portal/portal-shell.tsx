...
const links = [
  ...
  { href: "/portal/estoque", label: "Estoque", icon: "≋", roles: ["OWNER", "ADMIN", "MANAGER", "PHARMACIST", "OPERATOR", "VIEWER"] },
  { href: "/portal/produtos", label: "Produtos", icon: "▤", roles: ["OWNER", "ADMIN", "MANAGER", "PHARMACIST", "OPERATOR", "VIEWER"] },
  { href: "/portal/categorias", label: "Categorias", icon: "◉", roles: ["OWNER", "ADMIN", "MANAGER", "PHARMACIST", "VIEWER"] },
  { href: "/portal/compras", label: "Compras", icon: "◆", roles: ["OWNER", "ADMIN", "MANAGER", "FINANCE", "OPERATOR", "VIEWER"] },
  { href: "/portal/cotacoes", label: "Cotações", icon: "⇄", roles: ["OWNER", "ADMIN", "MANAGER", "FINANCE", "OPERATOR", "VIEWER"] },
  ...
  { href: "/portal/recebimento", label: "Recebimento NF-e", icon: "⇣", roles: ["OWNER", "ADMIN", "MANAGER", "PHARMACIST", "OPERATOR", "VIEWER"] },
  { href: "/portal/nfce", label: "Emissão NFC-e", icon: "▤", roles: ["OWNER", "ADMIN", "MANAGER", "PHARMACIST", "OPERATOR", "VIEWER"] },

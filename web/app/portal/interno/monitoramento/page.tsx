...
type Report = {
  ...
  indicators: { databaseLatencyMs: number; openIncidents: number; criticalIncidents: number; failedEmails: number; failedBillingEvents: number; activeSessions: number; failedAutomations: number };
